...
// }
// 
// Protocol::MCTilemap* MCTilemap::MakeWorldProtocol()const noexcept
// {
// 	auto mctilemap = ServerCore::xnew<Protocol::MCTilemap>();
// 
// 	//for (int chunkX = 0; chunkX < MCTilemap::CHUNK_SIZE; ++chunkX) {
// 	//	for (int chunkY = 0; chunkY < MCTilemap::CHUNK_SIZE; ++chunkY) {
// 	//		auto* chunk = mctilemap->add_tilechunks();
// 	//
// 	//		for (int z = 0; z < MCTileChunk::CHUNK_HEIGHT; ++z) {
// 	//			auto* layer = chunk->add_tiledata();
// 	//
// 	//			for (int x = 0; x < MCTileChunk::CHUNK_WIDTH; ++x) {
// 	//				for (int y = 0; y < MCTileChunk::CHUNK_HEIGHT; ++y) {
// 	//					int tileValue = this->tileChunk[chunkX][chunkY].GetTile(z, x, y);
// 	//					layer->add_tiles(tileValue); // 좌표 순서에 주의
// 	//				}
// 	//			}
// 	//		}
// 	//	}
